import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, getRequestURL, getResponseHeader, appendResponseHeader, removeResponseHeader, createError, getRouterParam, getResponseStatus, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler } from 'file://M:/github/dmxsan.github.io/node_modules/h3/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file://M:/github/dmxsan.github.io/node_modules/ufo/dist/index.mjs';
import destr from 'file://M:/github/dmxsan.github.io/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file://M:/github/dmxsan.github.io/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://M:/github/dmxsan.github.io/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://M:/github/dmxsan.github.io/node_modules/node-mock-http/dist/index.mjs';
import { klona } from 'file://M:/github/dmxsan.github.io/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://M:/github/dmxsan.github.io/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://M:/github/dmxsan.github.io/node_modules/scule/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://M:/github/dmxsan.github.io/node_modules/radix3/dist/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname, resolve, isAbsolute } from 'file://M:/github/dmxsan.github.io/node_modules/pathe/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://M:/github/dmxsan.github.io/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://M:/github/dmxsan.github.io/node_modules/unstorage/drivers/fs.mjs';
import file_58_47_47_47M_58_47github_47dmxsan_46github_46io_47node_modules_47nuxt_47dist_47core_47runtime_47nitro_47utils_47cache_45driver_46js from 'file:///M:/github/dmxsan.github.io/node_modules/nuxt/dist/core/runtime/nitro/utils/cache-driver.js';
import unstorage_47drivers_47fs_45lite from 'file://M:/github/dmxsan.github.io/node_modules/unstorage/drivers/fs-lite.mjs';
import localAdapter from 'file://M:/github/dmxsan.github.io/node_modules/db0/dist/connectors/better-sqlite3.mjs';
import { digest } from 'file://M:/github/dmxsan.github.io/node_modules/ohash/dist/index.mjs';

const serverAssets = [{"baseName":"server","dir":"M:/github/dmxsan.github.io/server/assets"}];
...
storage.mount('internal:nuxt:prerender', file_58_47_47_47M_58_47github_47dmxsan_46github_46io_47node_modules_47nuxt_47dist_47core_47runtime_47nitro_47utils_47cache_45driver_46js({"driver":"file:///M:/github/dmxsan.github.io/node_modules/nuxt/dist/core/runtime/nitro/utils/cache-driver.js","base":"M:/github/dmxsan.github.io/.nuxt/cache/nitro/prerender"}));
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"./.data/kv"}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"M:/github/dmxsan.github.io","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"M:/github/dmxsan.github.io/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"M:/github/dmxsan.github.io/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"M:/github/dmxsan.github.io/.nuxt/cache"}));
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "1917dbd1-2ff7-4d10-a1c9-40ef31fa4dcc",
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "M:/github/dmxsan.github.io/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  }
};
...
const _XjaCdC = eventHandler((event) => {
...
const _H1xo2e = eventHandler(async (event) => {
...
const checksums = {
  "content": "v3.3.0--SIa00L_6R2jJhlpnFVlx-FOYXPBOZc5GLNxpkuzpRFY"
};
...
const _ShN12K = eventHandler(async (event) => {
...
const _lazy_rAjVDO = () => import('./renderer.mjs');

const handlers = [
  { route: '', handler: _XjaCdC, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump', handler: _H1xo2e, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _ShN12K, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_rAjVDO, lazy: true, middleware: false, method: undefined }
];
...
export { useRuntimeConfig as a, buildAssetsURL as b, defineRenderHandler as d, getRouteRules as g, publicAssetsURL as p, trapUnhandledNodeErrors as t, useNitroApp as u };
